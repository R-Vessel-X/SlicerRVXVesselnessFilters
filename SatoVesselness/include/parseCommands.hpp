...
//  /home/skvader/sources/SlicerExecutionModel/build/GenerateCLP/bin/GenerateCLP --InputXML /home/skvader/programming/these/SlicerVesselness/SatoVesselness/Sato.xml --returnparameterfile paramFiles.txt --OutputCxx /home/skvader/programming/these/SlicerVesselness/SatoVesselness/parseCommands.hpp
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
"    <title>OOF Vesselness Filter</title>\n"
"    <description>\n"
...
#define GENERATE_DECLARE \
 ...
 \
    ...
    nonbooleanFlags.push_back("--alpha1"); \
    nonbooleanFlags.push_back("-b"); \
    nonbooleanFlags.push_back("--alpha2"); \
...
#define GENERATE_TCLAP_PARSE \
 ...
 \
    msg.str("");msg << " (value: " << alpha1 << ")"; \
    TCLAP::ValueArg<double > alpha1Arg("a", "alpha1", msg.str(), 0, alpha1, "double", commandLine); \
 \
    msg.str("");msg << " (value: " << alpha2 << ")"; \
    TCLAP::ValueArg<double > alpha2Arg("b", "alpha2", msg.str(), 0, alpha2, "double", commandLine); \
 \
