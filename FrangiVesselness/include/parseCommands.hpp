...
//  /home/skvader/sources/SlicerExecutionModel/build/GenerateCLP/bin/GenerateCLP --InputXML /home/skvader/programming/these/SlicerVesselness/FrangiVesselness/Antiga.xml --returnparameterfile paramFiles.txt --OutputCxx /home/skvader/programming/these/SlicerVesselness/FrangiVesselness/parseCommands.hpp
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
"    <title>Antiga Vesselness Filter</title>\n"
"    <description>\n"
"        Antiga Vesselness filter, Generalization of Frangi vesselness.\n"
"    </description>\n"
"    <version>1.0</version>\n"
...
#define GENERATE_DECLARE \
 ...
 \
    ...
    nonbooleanFlags.push_back("-a"); \
    nonbooleanFlags.push_back("--alpha"); \
    nonbooleanFlags.push_back("-b"); \
    nonbooleanFlags.push_back("--beta"); \
    nonbooleanFlags.push_back("-g"); \
    nonbooleanFlags.push_back("--gamma"); \
...
#define GENERATE_TCLAP_PARSE \
 ...
 \
    ...
    TCLAP::ValueArg<double > alphaArg("a", "alpha", msg.str(), 0, alpha, "double", commandLine); \
 \
    msg.str("");msg << " (value: " << beta << ")"; \
    TCLAP::ValueArg<double > betaArg("b", "beta", msg.str(), 0, beta, "double", commandLine); \
 \
    msg.str("");msg << " (value: " << gamma << ")"; \
    TCLAP::ValueArg<int > gammaArg("g", "gamma", msg.str(), 0, gamma, "int", commandLine); \
 \
