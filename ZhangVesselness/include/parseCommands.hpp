...
//  /home/skvader/sources/SlicerExecutionModel/build/GenerateCLP/bin/GenerateCLP --InputXML /home/skvader/programming/these/SlicerVesselness/ZhangVesselness/Zhang.xml --returnparameterfile paramFiles.txt --OutputCxx /home/skvader/programming/these/SlicerVesselness/ZhangVesselness/parseCommands.hpp
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
"    <title>Zhang Vesselness Filter</title>\n"
"    <description>\n"
"        Zhang Vesselness filter, designed to improve results over frangi with less parameters.\n"
"    </description>\n"
"    <version>1.0</version>\n"
...
"        <integer>\n"
"            <name>nbClasses</name>\n"
"            <label>nbClasses</label>\n"
"            <flag>s</flag>\n"
"            <longflag>nbSeeds</longflag>\n"
"            <default>5</default>\n"
"            <constraints>\n"
"                <minimum>0</minimum>\n"
"                <maximum>10</maximum>\n"
...
"            <description>mask to be applied on the vesselness, always use mask on liver (see classes distribution)</description>\n"
"        </image>\n"
"        <image>\n"
...
#define GENERATE_DECLARE \
 ...
 \
    ...
    nonbooleanFlags.push_back("--tau"); \
    nonbooleanFlags.push_back("-s"); \
    nonbooleanFlags.push_back("--nbSeeds"); \
...
#define GENERATE_TCLAP_PARSE \
 ...
 \
    msg.str("");msg << " (value: " << Tau << ")"; \
    TCLAP::ValueArg<double > TauArg("t", "tau", msg.str(), 0, Tau, "double", commandLine); \
 \
    msg.str("");msg << " (value: " << nbClasses << ")"; \
    TCLAP::ValueArg<int > nbClassesArg("s", "nbSeeds", msg.str(), 0, nbClasses, "int", commandLine); \
 \
 ...
 \
    msg.str("");msg << "mask to be applied on the vesselness, always use mask on liver (see classes distribution)";    TCLAP::ValueArg<std::string > maskVolumeArg("k", "maskVolume", msg.str(), 0, maskVolume, "std::string", commandLine); \
 \
...
#define GENERATE_TCLAP_ASSIGNMENT \
      ...
      Tau = TauArg.getValue(); \
      nbClasses = nbClassesArg.getValue(); \
